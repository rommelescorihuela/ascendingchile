                ...
                <div class="col-md-12">
                    <form name="contact_form" class="default-form contact-form" action="<?php echo e(route('winwin')); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row form-winwin">
                            ...
                            <div class="col-sm-5 col-xs-12">
                                 <input type="text" name="servicios" required="" class="form-control" maxlength="255">
                            </div>
                            <div class="col-xs-12"><br></div>
                            <div class="col-sm-4 col-xs-12">
                                <h4>Industria</h4>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Real_Wrok\Camtravel\Ascending\www\resources\views/winwin.blade.php ENDPATH**/ ?>