...
<div class="container py-5">
    ...
    <?php endif; ?>
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Mis Ofertas Laborales (profesionales)</div>
                <p class="text-right"><a class="btn btn-success" href="<?php echo e(route('mis-ofertas-op')); ?>" style="margin-left: 10px;">Perfiles Operativos <i class="fa fa-external-link" aria-hidden="true"></i></a></p>
            </div>
<br>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ascendin/public_html/test/resources/views/emp/ofertas.blade.php ENDPATH**/ ?>