...
<script src="<?php echo e(asset('plugins/materialize/js/materialize.js')); ?>" defer></script>
<script>
...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="fnac" type="text" class="datepicker form-control <?php if ($errors->has('fnac')) :
if (isset($message)) { $messageCache = $message; }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ascendin/public_html/test/resources/views/pro/perfil.blade.php ENDPATH**/ ?>