...
function eliminar(operativo){
    console.info(operativo, operativo.operativo.id)
  Swal.fire({
    title: '¿Estás seguro?',
    text: "",
    icon: 'warning',
    ...
    if (result.value) {
      $.ajax({
        url: "<?php echo e(url('/eliminar-operativo')); ?>",
        method: "POST",
        headers: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ascendin/public_html/test/resources/views/admin/operativos.blade.php ENDPATH**/ ?>