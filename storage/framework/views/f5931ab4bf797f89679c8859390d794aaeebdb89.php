                  ...
                  <tbody>
                    <?php $__currentLoopData = $pros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr data-id="<?php echo e($pro->id); ?>">
                        ...
                        <?php endif; ?>
                        <p><button style="margin-top: 10px" onclick="eliminar(<?php echo e($pro->id); ?>)" class="btn btn-danger">Eliminar</button></p>
                        </td>
                      </tr>
...
function eliminar(id){
  Swal.fire({
    ...
    if (result.value) {
      $.ajax({
        url: "<?php echo e(url('/eliminar-winwin')); ?>",
        method: "POST",
        headers: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ascendin/public_html/test/resources/views/admin/winwin.blade.php ENDPATH**/ ?>