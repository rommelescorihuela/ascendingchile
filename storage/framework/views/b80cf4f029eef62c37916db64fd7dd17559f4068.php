...
<div class="container py-5">
    ...
    <?php if(isset($yo)): ?>
        <div class="col-md-4">
        <?php echo $__env->make('ope.menu', ['cual' => 1], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    <?php endif; ?>
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" <?php echo e((isset($yo) ? 'action='.url('perfil-op-edit') : '')); ?>>
                        <?php echo csrf_field(); ?>
<?php if(!isset($yo)): ?>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="nacionalidad" value="<?php echo e(old('nacionalidad', ($yo->nacionalidad ?? ''))); ?>" required autocomplete="nacionalidad" autofocus>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ascendin/public_html/test/resources/views/ope/perfil.blade.php ENDPATH**/ ?>