...
<div class="container py-5">
    ...
    <?php if(isset($yo)): ?>
        <div class="col-md-4">
        <?php echo $__env->make('emp.menu', ['cual' => 1], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    <?php endif; ?>
        <div class="col-md-8">
            <div class="card">
...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="gerente" type="text" class="form-control <?php if ($errors->has('gerente')) :
if (isset($message)) { $messageCache = $message; }
...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="contacto" type="text" class="form-control <?php if ($errors->has('contacto')) :
if (isset($message)) { $messageCache = $message; }
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    ...
                                    <input id="web" type="text" class="form-control <?php if ($errors->has('web')) :
if (isset($message)) { $messageCache = $message; }
...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="colaboradores" type="number" min="0" class="form-control <?php if ($errors->has('colaboradores')) :
if (isset($message)) { $messageCache = $message; }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Real_Wrok\Camtravel\Ascending\www\resources\views/emp/perfil.blade.php ENDPATH**/ ?>