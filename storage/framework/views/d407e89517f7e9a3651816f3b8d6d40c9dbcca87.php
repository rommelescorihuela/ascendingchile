          ...
          <div class="tab-content">
            ...
            <div class="service-box boxes text">
              <div class="row">
                ...
                <div class="col-md-4">
                  <br>
                  <a href="<?php echo e(route('perfiles-profesionales')); ?>" class="btn btn-style-one text-center">Buscar Perfiles</a>
                </div>
              </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Real_Wrok\Camtravel\Ascending\www\resources\views/servicios-empresas.blade.php ENDPATH**/ ?>