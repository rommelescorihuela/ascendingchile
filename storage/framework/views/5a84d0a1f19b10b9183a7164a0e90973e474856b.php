...
<div class="container py-5">
    ...
    <?php if(isset($yo)): ?>
        <div class="col-md-4">
        <?php echo $__env->make('ope.menu', ['cual' => 5], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    <?php endif; ?>
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Perfil Operativo - Currículum Vitae</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ascendin/public_html/test/resources/views/ope/cv.blade.php ENDPATH**/ ?>