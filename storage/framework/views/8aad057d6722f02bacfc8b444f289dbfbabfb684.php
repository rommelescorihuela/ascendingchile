  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel<?php echo e($pro->id); ?>">Perfil Profesional</h4><a href="<?php echo e(url('customer/Ofertaprint-pdf',$pro->id)); ?>">Print PDF</a>
      </div>
...
<?php /**PATH /var/www/html/test_2/resources/views/admin/ofertas-modal.blade.php ENDPATH**/ ?>