...
<script src="{{ asset('plugins/slick/slick.js') }}" defer></script>
<style>
...
<div class="hero-slider index">
    <!-- Slider Item -->
    <div class="slider-item slide1" style="background-image:url({{ asset('img/home-portada-2.jpg') }}); align-items: flex-end; padding-bottom: 2em;">
        <div style="width: 90%;">
            <div class="row">
                <div class="col-12">
                    <!-- Slide Content Start -->
                    <a href="{{ route('registrate') }}" class="btn btn-default btn-lg">Regístrate</a>
                    <!--a href="http://test.ascendingchile.cl/registro-empresa" class="btn btn-default btn-lg">Publica tus ofertas</a-->
                    
                    <!-- Slide Content Start -->
                    <!--a href="{{ route('nosotros') }}"><div class="content style text-left conocenos">
                        ...
                        <a href="{{ route('nosotros') }}" class="btn btn-main btn-white">CONÓCENOS</a-->
            ...
            <div class="col-md-12">
                <div class="cta-block">
                    <div class="bloque item info-bloque flexible">
                        ...
                        <a href="{{ route('servicios-personas') }}" class="desktop"><img src="{{ asset('img/servicios-a-personas.jpg') }}" class="img-responsive"></a>
                        ...
                        <a href="{{ route('servicios-personas') }}" class="btn-style-one">Más información</a>
                    </div>
                    <div class="bloque item info-bloque flexible">
                        <h2>Servicios a Empresas</h2>
                        <a href="{{ route('servicios-empresas') }}" class="desktop"><img src="{{ asset('img/servicios-a-empresas.jpg') }}" class="img-responsive"></a>
                        ...
                        <a href="{{ route('servicios-empresas') }}" class="btn-style-one">Más información</a>
                    </div>
                    <div class="bloque item info-bloque flexible">
                        <h2>Asesoría Comercial</h2>
                        <a href="{{ route('contacto') }}"><img src="{{ asset('img/asesorias-comerciales.jpg') }}" class="img-responsive"></a>
                        ...
                        <a href="{{ route('contacto') }}" class="btn-style-one">Más información</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row" style="margin: 40px auto;">
            <div class="col-md-12">
                <div class="carrusel">
                @foreach($wws as $logo)
                    <div><a href="https://{{ $logo->web }}" target="_blank" class="logo-web-home"><img src="{{ Storage::disk('public')->url('logos/'.$logo->logo) }}" class="img-perfil img-perfil-2 img-slider"></a></div>
                @endforeach
                </div>
            </div>
        </div>
