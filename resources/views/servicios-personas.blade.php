            ...
            <div class="service-box boxes text">
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  @auth
                    @if(Auth::user()->tipo == 1)
                      <a href="{{ route('ofertas-laborales') }}" class="btn btn-style-one text-center">Buscar Ofertas</a>
                    @endif
                  @else
                  <a href="{{ route('register') }}" class="btn btn-style-one text-center">Buscar Ofertas</a>
                  @endauth
                </div>
              </div>
            </div>
...
{{--
          ...
          <a href="{{ route('register') }}" class="btn btn-style-one text-center">Regístrate aquí</a>
          </div>
--}}
        </div>
      </div>
