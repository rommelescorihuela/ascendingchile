...
<br>
        <ul id="sidebar_menu" class="sidebar-nav">
          ...
          <li class="nav-item {{ ($cual == 2) ? 'active':'' }}">
            <a class="nav-link" href="{{ route('resumen') }}">Resumen</a>
          </li>
          <li class="nav-item {{ ($cual == 3) ? 'active':'' }}">
            <a class="nav-link" href="{{ route('experiencia') }}">Experiencia</a>
          </li>
          <li class="nav-item {{ ($cual == 4) ? 'active':'' }}">
            <a class="nav-link" href="{{ route('formacion') }}">Formación</a>
          </li>
          <li class="nav-item {{ ($cual == 5) ? 'active':'' }}">
            <a class="nav-link" href="{{ route('cv') }}">{{ ($yo->cv ? 'Ver CV' : 'Adjuntar CV') }}</a>
          </li>
          <li class="nav-item">
...
@if($yo->cv)
        <ul id="sidebar_menu" class="sidebar-nav">
          <li class="nav-item {{ ($cual == 6) ? 'active':'' }}">
            <a class="nav-link" href="{{ route('ofertas-laborales') }}">Ver Ofertas Laborales</a>
          </li>
          <li class="nav-item {{ ($cual == 7) ? 'active':'' }}">
            <a class="nav-link" href="{{ route('mis-postulaciones') }}">Mis Postulaciones</a>
          </li>
        </ul>
@endif
</div>