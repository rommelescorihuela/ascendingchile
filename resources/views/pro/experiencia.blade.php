                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea id="responsabilidades" class="form-control @error('responsabilidades') is-invalid @enderror" name="responsabilidades" value="{{ old('responsabilidades') }}" required autocomplete="responsabilidades" rows="3" maxlength="1000"></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea id="logros" class="form-control @error('logros') is-invalid @enderror" name="logros" value="{{ old('logros') }}" required autocomplete="logros" rows="3" maxlength="1000"></textarea>
                        ...
                        <div class="form-group row mb-0">
                            ...
                            <div class="col-md-5 text-right">
                                <a href="{{ route('formacion') }}" class="btn btn-light" style="color:#FFF;">
                                    {{ __('Ir a Formación Académica >') }}
                                </a>
                            </div>
                            @endif
                        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form method="POST" action="{{ route('edit-exp') }}">
                @csrf
