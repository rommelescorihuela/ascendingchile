    ...
    @endif
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('guarda-acad1') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="id" type="text" class="form-control @error('id') is-invalid @enderror" name="id" value="{{ old('id', ($yo->id ?? '')) }}" required autocomplete="id" autofocus>
                      ...
                      <tbody>
                        @foreach($exp as $xp)
                          <tr id="formacion-{{ $xp->id }}">
                            ...
                            <td class="text-right">
                                <form action="{{ url('del-form1') }}" method="post" id="form-{{ $xp->id }}">
                                @csrf
