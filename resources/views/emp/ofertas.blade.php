    ...
    @endif
        <div class="col-md-8">
            <div class="card">
                ...
                <p class="text-right"><a class="btn btn-success" href="{{ route('mis-ofertas-op') }}" style="margin-left: 10px;">Perfiles Operativos <i class="fa fa-external-link" aria-hidden="true"></i></a></p>
            </div>
<br>
            @if(count($ofertas) >= 1)
