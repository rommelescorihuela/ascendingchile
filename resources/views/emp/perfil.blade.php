    ...
    @endif
        <div class="col-md-8">
            <div class="card">
                ...
                @else
                DATOS PARA CREAR PERFIL O REGISTRO EMPRESA
                @endif
                </div>
...
@endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="gerente" type="text" class="form-control @error('gerente') is-invalid @enderror" name="gerente" value="{{ old('gerente', ($yo->gerente ?? '')) }}" required autocomplete="gerente">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="contacto" type="text" class="form-control @error('contacto') is-invalid @enderror" name="contacto" value="{{ old('contacto', ($yo->contacto ?? '')) }}" required autocomplete="contacto">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    ...
                                    <input id="web" type="text" class="form-control @error('web') is-invalid @enderror" name="web" value="{{ old('web', ($yo->web ?? '')) }}" required autocomplete="web">
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="colaboradores" type="number" min="0" class="form-control @error('colaboradores') is-invalid @enderror" name="colaboradores" value="{{ old('colaboradores', ($yo->colaboradores ?? '')) }}" required autocomplete="colaboradores">
