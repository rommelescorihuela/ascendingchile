                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="ubicacion" type="text" class="form-control @error('ubicacion') is-invalid @enderror" name="ubicacion" value="{{ old('ubicacion') }}" required autocomplete="ubicacion" maxlength="255">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="superior" type="text" class="form-control @error('superior') is-invalid @enderror" name="superior" value="{{ old('superior') }}" required autocomplete="superior" maxlength="255">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea id="supervisa" class="form-control @error('supervisa') is-invalid @enderror" name="supervisa" required autocomplete="supervisa" rows="4" maxlength="255">{{ old('supervisa') }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea id="proposito" class="form-control @error('proposito') is-invalid @enderror" name="proposito" required autocomplete="proposito" rows="4" maxlength="1000">{{ old('proposito') }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea id="funciones" class="form-control @error('funciones') is-invalid @enderror" name="funciones" required autocomplete="funciones" rows="4" maxlength="1000">{{ old('funciones') }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="competencias" type="text" class="form-control @error('competencias') is-invalid @enderror" name="competencias" value="{{ old('competencias') }}" required autocomplete="competencias" maxlength="255">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="comunicacion" type="text" class="form-control @error('comunicacion') is-invalid @enderror" name="comunicacion" value="{{ old('comunicacion') }}" required autocomplete="comunicacion" maxlength="255">
