<!-- Modal -->
<div class="modal fade" id="info-perfil-{{ $pro->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel{{ $pro->id }}">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel{{ $pro->id }}">Perfil Profesional</h4><a href="{{url('customer/Profesionalprint-pdf',$pro->id)}}">Print PDF</a>
      </div>
